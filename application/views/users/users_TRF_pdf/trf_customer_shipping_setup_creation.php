                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="msrf">
                                <section id="new">
                                    <div class="row">
                                        <form id="trf_css_form" action="<?= site_url('UsersTraccReq_controller/user_creation_customer_shipping_setup_pdf'); ?>" method="POST">
                                            <div class="col-md-12">
...
<script>
    $(document).ready(function() {
        ...
        $('#submitBtn').click(function (e) {
            ...
            var form = document.getElementById('trf_css_form');
