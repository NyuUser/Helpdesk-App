                                            ...
                                            <div class="col-md-12 text-center">
                                                <div class="form-group d-flex justify-content-center">
                                                    <div class="checkbox-inline custom-checkbox">
                                                        <input type="checkbox" name="checkbox_lmi" id="checkbox_lmi" value="LMI" <?= $checkbox_lmi ? 'checked' : '' ?>>
                                                        <label for="checkbox_lmi" class="checkbox-label">LMI</label>
                                                    </div>
                                                    <div class="checkbox-inline custom-checkbox">
                                                        <input type="checkbox" name="checkbox_rgdi" id="checkbox_rgdi" value="RGDI" <?= $checkbox_rgdi ? 'checked' : '' ?>>
                                                        <label for="checkbox_rgdi" class="checkbox-label">RGDI</label>
                                                    </div>
                                                    <div class="checkbox-inline custom-checkbox">
                                                        <input type="checkbox" name="checkbox_lpi" id="checkbox_lpi" value="LPI" <?= $checkbox_lpi ? 'checked' : '' ?>>
                                                        <label for="checkbox_lpi" class="checkbox-label">LPI</label>
                                                    </div>
                                                    <div class="checkbox-inline custom-checkbox">
                                                        <input type="checkbox" name="checkbox_sv" id="checkbox_sv" value="SV" <?= $checkbox_sv ? 'checked' : '' ?>>
                                                ...
                                                <div class="col-md-6 text-left" style="margin-left: -150px;">
                                                    <div class="form-group d-flex flex-column align-items-center">
                                                        ...
                                                        <div class="circle-checkbox mb-2">
                                                            ...
                                                            <?= isset($checkbox_update['system_date_lock']) && $checkbox_update['system_date_lock'] ? 'checked' : ''; ?>>
                                                        ...
                                                        <div class="circle-checkbox mb-2">
                                                            ...
                                                            <?= isset($checkbox_update['user_file_access']) && $checkbox_update['user_file_access'] ? 'checked' : ''; ?>>
                                                        ...
                                                        <div class="circle-checkbox mb-2">
                                                            ...
                                                            <?= isset($checkbox_update['item_details']) && $checkbox_update['item_details'] ? 'checked' : ''; ?>>
                                                        ...
                                                        <div class="circle-checkbox mb-2">
                                                            ...
                                                            <?= isset($checkbox_update['customer_details']) && $checkbox_update['customer_details'] ? 'checked' : ''; ?>>
